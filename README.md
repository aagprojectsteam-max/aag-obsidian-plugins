...
| [Smart Paste](https://github.com/aagprojectsteam-max/aag-obsidian-smartpaste) | [0.6.0](https://github.com/aagprojectsteam-max/aag-obsidian-smartpaste/releases/tag/0.6.0) | 1.13.7 |
| [SideNotes](https://github.com/aagprojectsteam-max/aag-obsidian-sidenotes) | [0.2.1](https://github.com/aagprojectsteam-max/aag-obsidian-sidenotes/releases/tag/0.2.1) | 1.13.7 |
...
SmartPaste 0.6.0 adds an optional association command for an already installed compatible private AAG Anki Bridge/AnkiSuit pair. Those components are not included in this catalog or cleared for public redistribution. Standalone SmartPaste features remain available without Anki.
